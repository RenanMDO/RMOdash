      ...
      <Stack direction="row" spacing="2">
        ...
        {currentPage > (1 + sibilingsCount) && (
          <>
            ...
            {currentPage > (2 + sibilingsCount) && <Text color="gray.300" width="8" align="center">...</Text>}
          </>
        )}
        ...
        {(currentPage + sibilingsCount) < lastPage && (
          <>
            {(currentPage + 1 + sibilingsCount) < lastPage && <Text color="gray.300" width="8" align="center">...</Text>}
